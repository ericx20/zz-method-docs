...
We currently have a collection of 50 solves from Yoruba, check it out!

<Cards>
  <Card icon={<Image src={logo} width={40} />} title="Yoruba's 7.19 ao50" href="/example-solves/yoruba-7.19-ao50" />
</Cards>
