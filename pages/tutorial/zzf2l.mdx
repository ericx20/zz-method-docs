...
<TwistyPlayer
  ...
  background="none"
  experimentalSetupAlg="R' U R L U L2 U L"
  alg="L U' L'"
  cameraLongitude="-30"
/>
...
<TwistyPlayer
  experimentalStickeringMaskOrbits="EDGES:IIIIDDDDII-I,CORNERS:IIIIIII-,CENTERS:IDDDDD"
  background="none"
  experimentalSetupAlg="R' U R L U L2 U L2 U' L'"
  alg="L' U' L"
  cameraLongitude="-30"
/>
<span>Moves: `L' U' L`</span>
...
<TwistyPlayer
  ...
  background="none"
  experimentalSetupAlg="L' U L U L' U' L"
  alg="L U2 L'"
  cameraLongitude="-30"
/>
<span>Moves: `L U2 L'`</span>
...
Here's the FL pair, the corner has the yellow D sticker on the top side so it's Case A.

<TwistyPlayer
  experimentalStickeringMaskOrbits="EDGES:IIIIDDDDDID-,CORNERS:IIIIDI-D,CENTERS:IDDDDD"
  background="none"
  experimentalSetupAlg="L U L' U' L U2 L' U' "
  alg="U L U2 L'"
  cameraLongitude="-30"
/>
...
This is the BL pair. Both pieces have blue on the top, so this is Case B.

<TwistyPlayer
  experimentalStickeringMaskOrbits="EDGES:IIIIDDDDDDD-,CORNERS:IIIIDD-D,CENTERS:IDDDDD"
  background="none"
  experimentalSetupAlg="L U L' U2 L U' L' "
  alg="L U L'"
  cameraLongitude="-30"
/>
<span>Moves: `L U L'`</span>
...
Consider this BR pair. The top stickers of the two pieces are red and blue.
They don't match, and we also don't see a D sticker (yellow) so it's Case C.
...
Finally it's time to solve our joined/split pair.

If it's a joined pair, move it out of R or L layer (whichever one contains the slot we're solving).
This moves the pair out of the way, so it won't get separated by the basic insert.
...
If it's a split pair, turn the U layer so that the corner is above the slot we're solving.
Unlike the joined pair, there's only one position that works for the basic insert.
