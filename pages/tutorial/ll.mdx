...
An important pattern for OCLL recognition is called **headlights:** when two adjacent corners have matching stickers on the side.
...
<TwistyPlayer
  ...
  experimentalSetupAlg="R U R' U' R' F R2 U' R' U' R U R' F' U2"
  background="none"
  controlPanel="none"
  className={styles.headlights}
  hintFacelets="none"
...
There are 21 PLL algs, but the nice part is that you'll already know 6 PLLs from CPLL and EPLL.
