...
### Fix 4 bad edges at once

`F` or `F'` will flip the orientation of all 4 edges on the **F**ront layer.

<TwistyPlayerDoubleSprite
  experimentalSetupAlg="F'"
  alg="F"
  moveIndexToChangeSprite={0}
  firstSprite="/assets/minus-4.png"
  secondSprite="/assets/minus-4-after.png"
  tempoScale={0.5}
/>

We can use natural moves to move 4 bad edges to the **F**ront layer.
Continuing our example, we see there's already 2 bad edges at the front.
We can do `L'` to move a 3rd edge to the front, and `U2` for the 4th edge.

{/* TODO: add twisty alg viewer */}

<TwistyPlayerDoubleSprite
  experimentalSetupAlg="F' R' D B U2 R' U R D2 L B2 R L U2 F2 B2 L B2 R' z"
  alg="L' U2' F"
  moveIndexToChangeSprite={2}
  firstSprite="/assets/eo-example-1-5.png"
  secondSprite="/assets/eo-example-1-5-after.png"
  showHintSprite
  tempoScale={0.7}
  cameraLongitude="-30"
  cameraLatitude="22"
