...
We present an innovative EO tutorial that makes EO intuitive and easy to learn. It goes beyond stating the rules of how to solve it, by showing how the rules emerge from a simple concept. It uses animated 3D cubes to visualize how EO works.
