...
Now for the actual alg-learning part: By going into the ZBLL sheets you'll see the algorithms getting bundled together in groups of 12, by their corner permutation. It's important that you try to go through this group of 12 in one sitting. You don't want to learn only a few algorithms at once because that will hinder your ability to distinguish cases from each other, which will hinder your 'Case-Alg' connection, and make recognition of the cases harder down the line. On the other hand, you don't want to learn too much at once because you don't want to spend too much time of your life learning rubik's cube algorithms. So go with 12 at a time.
