...
import { RECONS, YOUTUBE_VIDEO_ID } from "reconstructions/en/yoruba-7.19-ao50";
...
[Example Solve Library](/zz/example-solves) is a new section on this website dedicated to ZZ solve reconstructions.
...
We're launching the Library with 50 solves from Yoruba, the fastest ZZ user and author of the [Improvement Guide](/zz/improvement-guide).
