...
import { ReconViewer } from 'components/ReconCollection'
...
Example solves show you how skilled cubers do it. You can learn their tricks and incorporate them into your own solves.
...
It's hard to find solves with modern approaches such as EOCross and ZBLL.
...
<ReconViewer recon={YORUBA_AO50[15]} index={15} />

## Yoruba's 7.19 Ao50

We're launching the Library with 50 solves from Yoruba, the fastest active ZZ user currently.
