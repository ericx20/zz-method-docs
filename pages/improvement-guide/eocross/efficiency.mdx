...
1. EO+2 -> the rest. This is where you orient the edges and solve 2 cross edges at the same time, and then you solve the remaining cross pieces. The EO+2 step should influence the last 2 edges as much as possible (most commonly used for 0, 2, 4, and 6-flips). \
...
2. Partial EO+2 -> solve the other 2 while finishing EO. In this approach, you orient some, but not all of the edges while solving 2 cross edges, and then you orient the remaining edges and solve the remaining cross edges. (used mainly for higher n-flips: 6+).  \
...
3. Cross > EO. This is by far the rarest approach, and is only really used in 2-flips from time to time when you can cancel into a sledge at the end. \
...
Now that you have your average movecount, you want to set your target movecount. It should be set 1-2 moves below your average movecount.
