...
1. EO+2 -> the rest. This is where you solve your EO and any of the 2 cross edges as one step, and then you solve the rest of the cross. The EO+2 step should influence the last 2 edges as much as possible (most commonly used, for 0, 2, 4, and 6-flips). \
