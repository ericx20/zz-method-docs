...
Low movecount isn't everything. The goal is to solve as possible, not to be as efficient as possible. Ergonomics and ease of planning can justify a longer EOCross solution. If you see a 10 or an 11 move solution that can be done quickly, go for it.
...
Because we still want to know how to deal with the harder scrambles, and not every solution will be obvious. Also, more often than not, move efficient solutions turn out to be more ergonomic. We just don't want to do a computer optimal solution with horrid ergonomics when there's a much faster option for 1-2 moves sacrifice.
