...
Because we still want to know how to deal with the harder scrambles, and not every solution will be obvious. Also, more often than not, move efficient solutions turn out to be more ergonomic. The point of this is that we don't want to do a computer optimal solution with horrid ergonomics when there's a much faster option for 1-2 moves sacrifice.
