...
If you're really stuck, go to Solvers > EOCross to see what the computer will give you (for x2y, check the first 4 solutions). What 2 first cross edges does it solve, how does it deal with EO, what approach does it use? You can also use computer generated solutions to find other techniques that you haven't considered. 
