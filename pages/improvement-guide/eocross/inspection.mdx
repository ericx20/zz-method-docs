...
Now, there are some scrambles where you might not see an easy start. That might be partially an issue of not practicing efficiency enough, but there will be some scrambles where there genuienly won't be anything.
For these scrambles, you should still check the available, less efficient EO+2s.
It might so happen that there will be such an EO+2 that will result in only 0-2 moves left to finish (or just generally a very quick finish). In this case, go for that solution.

If the scramble still has no such EO+2s (very rare with x2y, and if you practice your efficiency more), then it's one of the hardest ones, which have the longest solutions. There are 2 ways to handle these:
...
Step 2 of the Intermediate Approach will be the most time consuming. To get better at it, practice it a lot through the mentioned drills in the [Practicing article](/improvement-guide/practicing). Once you get efficiency down, you want to be practicing this for how fast you can spot a good EO+2.
