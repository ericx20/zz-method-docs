...
- Look at a pair, and immediately know the solution, as well as the quality of that solution. You can categorize into 3 cases: free pairs/3 movers, 6-7 movers (pieces in U), and the rest.
